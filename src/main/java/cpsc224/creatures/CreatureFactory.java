...
public class CreatureFactory {
    ...
    public static Player createPlayer() {
        ...
        final CreatureModifiers cm = new CreatureModifiers(1, .2, new double[]{1.0, 1.0, 1.0, 1.0});
    ...
    public static Creature createRat() {
        ...
        final int health = 10;
        final CreatureModifiers cm = new CreatureModifiers(1, .3, new double[]{1.0, 1.0, 1.0, 1.0});
